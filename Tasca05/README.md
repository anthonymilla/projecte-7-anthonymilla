...
- Pendrives i USB: Perill de la infecció per malware i la pèrdua de dades no xifrades.
...
- Llistat de fonts consultades: URL específiques de documents (no genèriques) referències a documents.
- Arxius de vídeo:
  - Dos vídeos d’una durada entre **5 i 6 minuts**.
